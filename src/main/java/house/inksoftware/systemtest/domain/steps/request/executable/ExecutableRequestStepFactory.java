...
public class ExecutableRequestStepFactory {
    ...
    public static ExecutableRequestStep create(String baseFolder, RequestStep requestStep) throws Exception {
        ...
        if (requestFile.getName().equals("rest-request.json")) {
            ...
            throw new IllegalArgumentException("Unknown step file name: " + requestFile.getName() + ". Allowed requests names are: rest-request.json, kafka-request.json");
        }
    }
}
